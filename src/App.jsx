...
const tokenModule = sdk.getTokenModule(
  "0xa249cc8314E2299248563b31f692Da6929C84DF4"
);

const voteModule = sdk.getVoteModule(
  "0x6E5ea59c141a8A18A5B6CaA0C71DF30a5e106748",
);
 ...
 if (hasClaimedNFT) {
    return (
      <div className="member-page">
        <h1>🤔DAO Public Wall</h1>
        <p>💙 What's on your mind, Thinker? 💙</p>
        <div>
          <div>
            <h2>Member List</h2>
